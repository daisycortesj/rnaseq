...
def build_parser():
    ap = argparse.ArgumentParser(
        description="RNA-seq pipeline: QC, alignment, assembly, DE, BLAST, domains"
    )

    ap.add_argument(
        "--mode", choices=MODES, default="auto",
        help=(
            "Pipeline mode: 'index' (build STAR index), 'align' (align reads), "
            "'trinity' (de novo assembly), 'qc' (quality control), "
