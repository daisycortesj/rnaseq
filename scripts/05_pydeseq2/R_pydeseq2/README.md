...
|------|----------------|----------|
| `gene_count_matrix.tsv` | `sbatch scripts/04_counting/run_featurecounts.sbatch DC` | `03_count_tables/00_1_DC/` |
...
sbatch scripts/10_post_analysis/run_post_analysis.sbatch DC cyp

# Or individually:
sbatch scripts/10_post_analysis/run_phylo_heatmap.sbatch DC cyp
sbatch scripts/10_post_analysis/run_genomic_clustering.sbatch DC cyp
```
